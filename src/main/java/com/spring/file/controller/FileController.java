...
import com.spring.file.payload.FileResponse;
...
public class FileController {
	...
	public ResponseEntity<FileResponse> fileUpload(@RequestParam("image") MultipartFile image) {
		...
		try {
			...
			e.printStackTrace();
			return new ResponseEntity<>(new FileResponse(null, "image is not uploaded due to errror on server"), HttpStatus.INTERNAL_SERVER_ERROR);			
		}
